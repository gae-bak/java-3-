...
public class OptionalProcessingMain {
    public static void main(String[] args) {
        ...
        optValue.ifPresentOrElse(v -> System.out.println("optValue = " + v), () -> System.out.println("optValue는 비어있음"));
        optEmpty.ifPresentOrElse(v -> System.out.println("optValue = " + v), () -> System.out.println("optValue는 비어있음"));
        ...
        // flat map map()과 유사하나, 이미 Optional을 반환하는 경우 중첩을 제거
        ...
        optValue.stream().forEach(s -> System.out.println("optValue = " + s));
        optEmpty.stream().forEach(s -> System.out.println("optValue = " + s));
    }
}
