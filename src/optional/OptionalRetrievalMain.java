...
public class OptionalRetrievalMain {
    ...
    public static void main(String[] args) {
        // 문자열 "Java"가 있는 Optional과 비어있는 Optional 준비
        ...
        // String getValue2 = optEmpty.get() -> NSEE
        ...
        // 값이 없을 때만 람다(Suppiler)가 실행되어 기본값 생성
        ...
        Optional<String> result1 = optValue.or(() -> Optional.of("Fallbck"));
